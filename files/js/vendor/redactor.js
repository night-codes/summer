...
(function ($) {
	...
	var Redactor = function (element, options) {
		...
		this.opts = $.extend({
			...
			buttonsCustom: {},
			buttonsAdd: [],
			buttons: ["formatting", "|", "bold", "italic", "underline", "deleted", "|", "unorderedlist", "orderedlist", "outdent", "indent", "|", "image", "table", "link", "|", "fontcolor", "backcolor", "|", "alignment", "|", "horizontalrule", "html", "fullscreen"],
